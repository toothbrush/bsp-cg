/**
	Transforms Matrix-Market format plus meta-data after partitioning (by e.g., Mondriaan),
	to a binary triplet format optimised for BICRS use.

	Copyright A.N. Yzelman, April 2010
