...
/**
	Reads in Matrix-Market format plus meta-data after partitioning (by e.g., Mondriaan),
	and loads the doubly SBD format into a hierarchical BICRS scheme for enhanced SpMV.
	Will use ICRS and ICCS formats within the hierarchical scheme.

	Copyright A.N. Yzelman, August 2010

	Warning: this code uses assertions. Define the NDEBUG flag for production use.
*/
